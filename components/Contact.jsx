...
const Contact = () => {
  ...
  return (
    <div id='contact' className='w-full px-[12%] py-10 scroll-mt20  bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
      ...
      <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-6 mt-10 mb-8'>
            <input name='name' type="text" placeholder='Enter Your Name' required className='backdrop-blur-sm flex-1 p-3 outline-none border-[0.5px] border-gray-400 rounded-md dark:bg-[var(--color-dark-hover)]/30 dark:border-white/90'/>
            <input name='email' type="email" placeholder='Enter Your Email' required className='backdrop-blur-sm flex-1 p-3 outline-none border-[0.5px] border-gray-400 rounded-md dark:bg-[var(--color-dark-hover)]/30 dark:border-white/90'/>
        </div>
        <textarea name='message' rows="6" placeholder='Enter Your Message' required className='backdrop-blur-sm w-full p-4 outline-none border-[0.5px] border-gray-400 rounded-md dark:bg-[var(--color-dark-hover)]/30 dark:border-white/90'></textarea>
        <br></br>
        <br></br>
