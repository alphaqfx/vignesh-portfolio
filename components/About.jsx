...
return (
    <motion.div id='about' className='w-full px-[12%] py-10 scroll-mt20'
    initial={{ opacity: 0 }}
    ...
    >
        ...
        className='text-center mb-2 text-xl font-jost'>Introduction</motion.h4>
        <motion.h2 
        initial={{ opacity: 0, y: -20 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5, delay: 0.5 }}
        className='text-center text-5xl font-jost'>About Me</motion.h2>
        ...
        className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
            ...
            className='flex-1'>
                ...
                transition={{ duration: 0.5, delay: 0.3 }}
                className='text-lg my-6 text-gray-700 font-jost dark:text-white/80'>Tools I use</motion.h4>
                <motion.ul 
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
