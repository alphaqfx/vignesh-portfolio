  ...
  return (
    <div id='portfolio' className='w-full px-[12%] py-10 scroll-mt20'>
      ...
      <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-jost'>
        Here are some of my recent projects that showcase my skills and expertise in digital marketing.
      </p>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 my-10 gap-5 dark:text-black'>
        <div className="relative w-full max-w-2xl h-0 pb-[56.25%] rounded-2xl overflow-hidden shadow-lg">
          <iframe
            src="https://www.youtube.com/embed/S14ptPVGEcU?autoplay=1&mute=1&enablejsapi=1&modestbranding=1&rel=0"
            title="YouTube Video"
      ...
      <a href=""
        className='backdrop-blur-sm w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] border-gray-700 rounded-full py-3 px-10 mx-auto my-20 hover:bg-[var(--color-light-hover)] duration-500 dark:text-white dark:border-white dark:hover:bg-[var(--color-dark-hover)]'>
        Show More
