  ...
  return (
    ...
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      ...
      transition={{ duration: 0.8, type:'spring' , stiffness: 45 }}>
        ...
        className='flex items-end gap-2 text-xl md:text-2xl font-jost mb-3'>
        ...
        className='text-3xl sm:text-6xl lg:text-[50px] font-jost'>
        ...
        className='max-w-2xl mx-auto font-jost'>
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
            ...
            href="/vignesh-resume.pdf" download className='backdrop-blur-sm px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2 bg-white dark:text-black'>My Resume
